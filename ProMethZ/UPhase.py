...
"""
plt.plot(history[1:IterationNumber-1,1],label="Error in Dosage Matrix");
plt.legend(loc=2, ncol=2)
plt.savefig('Dosage.png', dpi=300)

plt.plot(history[1:IterationNumber-1,2],label="Error in Effectiveness Matrix");
plt.legend(loc=2, ncol=2)
plt.savefig('Effectiveness.png', dpi=300)
"""
